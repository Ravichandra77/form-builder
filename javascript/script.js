        ...
        el.each(function () {
            ...
            if (data_type === 'text') {
                ...
                if (checkbox.is(':checked')) {
                    requiredSymbol = '<span class="requiredSymbol">*</span>';
                    required = 'required';
                }
                html += '<div class="form-group"><label class="control-label">' + label + '</label> ' + requiredSymbol + '<input type="text" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label> ' + requiredSymbol + '<input type="number" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'email') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label> ' + requiredSymbol + '<input type="email" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'password') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label> ' + requiredSymbol + ' <input type="password" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'textarea') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label> ' + requiredSymbol + '<textarea rows="5" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'date') {
                var checkbox = $(this).find('.form-check-input');
                var requiredSymbol = '';
...
var formObjects = {
    tb: {
        firstObj: {
            closeBtn: {
                type: "button",
                dataFeild: function generateField() {
                    return Math.floor(Math.random() * (100000 - 1 + 1) + 57);
                        }          
                    },
                },
        secondObj:
        {
            label: {
                type: "text",
                labelValue: "Enter the label value",
                nameAttr: "label_" + function generateField() {
                    return Math.floor(Math.random() * (100000 - 1 + 1) + 57);
                },
            },
        },
        ThirdObj:
        {
            placeholder: {
                type: "text",
                placeholderValue: "Enter Placeholder value",
                nameAttr: "placeholder_" + function generateField() {
                    return Math.floor(Math.random() * (100000 - 1 + 1) + 57);
                }
            },
        },
        fourthObj:
        {
            name: {
                type: "text",
                nameValue: "Enter name attribute value",
                nameAttr: "text_" + function generateField() {
                    return Math.floor(Math.random() * (100000 - 1 + 1) + 57);
                }
            },
        },
    ...
    ErrorMsgs: {
        ...
        sNameError: "Enter your second name",
        fullName: "Enter your full name",
        radioError: "Radio button is not selected",
        checkboxError: "Not checked any checkbox",
        emailError: "Email must be entered",
        invalidEmailError: "Enter valid email",
        numberError: "Phone number should be Entered",
        passwordError: "Password should be entered",
        psdNotCorrect: "Password is not correct",
        dateError: "Date should be selected"
    }
